...
function getMetaTitle(){
    echo "Tambah Data Tempat Parkir";
}
...
if($method == 'POST'){
    ...
    $sql = "INSERT INTO parkirans (nama_tempat, detail_alamat, kapasitas_motor, kapasitas_mobil, latitude, longitude, id_user) values('$nama_tempat', '$detail_alamat', '$kapasitas_motor', '$kapasitas_mobil', '$latitude', '$longitude', '$id_user')";
        ...
        <div class="card border-0">
          <div class="card-body">
            <div class="card-title mb-5 ">
                <h3 class="">Tambah - Data Tempat Parkir</h3>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" rows=3 name="detail_alamat" required></textarea>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="row align-items-center mb-3">
                                ...
                                <div class="col-auto">
                                    <div class="input-group input-counter">
                                        ...
                                        <input type="text" class="form-control text-center" placeholder="0" name="kapasitas_motor" id="kapasitas_motor" required>
                            ...
                            <div class="row align-items-center mb-3">
                                ...
                                <div class="col-auto">
                                    <div class="input-group input-counter">
                                        ...
                                        <input type="text" class="form-control text-center" placeholder="0" name="kapasitas_mobil" id="kapasitas_mobil" required>
                                        <div class="input-group-append">
...
<script>
	...
	var mymap = L.map('mapid').setView([-6.175329, 106.827235], 12);
